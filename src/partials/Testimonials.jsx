          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-white shadow-md" data-aos="fade-up">
              ...
              <div className="flex flex-col h-full p-6 bg-white shadow-md" data-aos="fade-up" data-aos-delay="200">
                ...
                {/* 3rd testimonial */}
                <div className="flex flex-col h-full p-6 bg-white shadow-md" data-aos="fade-up" data-aos-delay="400">
                  <div>
                    <div className="relative inline-flex flex-col mb-4">
                    ...
                    <blockquote className="text-lg text-black grow">"I love my note app! It's become an essential tool for me to stay organized and keep track of all my ideas and tasks."</blockquote>
                    <div className="text-black font-medium mt-6 pt-5 border-t border-gray-700">
                      <cite className="text-black font-bold not-italic">Mary Splin</cite> - <a className="text-[#ff4d30] hover:text-gray-200 transition duration-150 ease-in-out" href="#0">Canada</a>
                    </div>
                  </div>
